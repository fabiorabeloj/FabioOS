import type { AgentLayer, Zone } from "../types.js";
import { MAESTRO_VISUAL_ALIASES } from "../maestro/aliases.js";
...
export function homeZoneFor(agentId: string, layer: AgentLayer): Zone {
  return AGENT_VISUAL_CLASSES[agentId]?.homeZone ?? "Classificação";
}
