...
| `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/40_Decisoes/` | `50_Registros/Decisoes/` ou `50_Registros/ADR/` | Migrar decisoes em formato ADR quando fizer sentido |
| `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/40_Repertorio/` | `40_Wiki/` ou manter como repertorio transitorio | Integrar gradualmente |
| `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/50_Fontes/` | `05_Raw_Sources/` | Converter indices antigos ou preservar em arquivo |
...
- mapas de `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/10_Mapas/`;
- projetos em `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/20_Projetos/`;
- conhecimento em `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/30_Conhecimento/`;
- decisoes em `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/40_Decisoes/`;
- fontes antigas em `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/50_Fontes/`;
...
3. Migrar primeiro `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/40_Decisoes/` para `50_Registros/Decisoes/` em lote pequeno.
