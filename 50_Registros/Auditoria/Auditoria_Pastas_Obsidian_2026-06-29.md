...
| `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/50_Fontes/`, `05_Raw_Sources/_compat_sources/` e `05_Raw_Sources/` | `50_Fontes` contem indices antigos; `sources` contem fontes brutas reais; `05_Raw_Sources` e o destino v2. | `05_Raw_Sources/` vira canonico para fonte bruta; `05_Raw_Sources/_compat_sources/` fica compatibilidade operacional. |
...
| `40_Wiki/_compat_wiki/`, `90_Arquivo/Legado_Pre_LLM_Wiki_2026-06-29/30_Conhecimento/` e `40_Wiki/` | Todos podem parecer conhecimento. | `40_Wiki/` = conhecimento processado alvo; `40_Wiki/_compat_wiki/` fica compatibilidade operacional ate migracao de links/RAG/MCP. |
...
3. Atualizar `60_Sistemas/FabioOS/bootstrap/CLAUDE.md`, mapa e status para impedir novas criacoes no lugar errado.
...
- a regra aparece no `60_Sistemas/FabioOS/bootstrap/CLAUDE.md`;
