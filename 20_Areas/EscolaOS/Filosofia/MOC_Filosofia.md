...
autoria: base de conhecimento (adaptável ao currículo do Prof. Fabio)
criado_em: 2026-07-01
tags: [escolaos, filosofia, moc, curriculo, base-conhecimento]
---

# MOC — Filosofia (base de conhecimento)

> Hub-mestre da Filosofia. Cada conceito é um nó pensável e ligado. Volume que
> **cresce por ideias conectadas**, não por dados soltos. Adapte ao seu plano de
> ensino; cada nó já serve de aula, revisão e questão.
...
## Medieval e Moderna
- [[descartes-duvida-metodica]] — o penso, logo existo; fundamento da razão.
- Racionalismo × empirismo *(a expandir)*.
- [[kant-imperativo-categorico]] — o dever e a autonomia da razão.

## Política e sociedade
- Contratualistas: Hobbes, Locke, Rousseau *(a expandir)*.
...
## Como isso vira volume
Cada thinker/tema acima é um nó; cada nó puxa sub-conceitos, obras, questões e
aulas. **Me mande seu material (provas, apostilas, planos de Geo e Fil) e eu
multiplico isto para o seu currículo real — dezenas a centenas de nós conectados.**

## Relações
- [[20_Areas/EscolaOS/README]]
